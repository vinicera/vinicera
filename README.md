...
# Hey, I’m Vinícius Borelli 👋

**AI student · Founder · Builder**

*Studying Artificial Intelligence @ UFCAT, Brazil*
*Building [Lyra](https://lyraestudos.com.br) — an adaptive EdTech platform for vestibular prep*
...
- 🎓 First-year **AI degree student** at UFCAT (Catalão, GO — Brazil)
- 🚀 Founder of **Lyra Estudos** — AI-driven diagnostics, mentor channels & adaptive study analytics
- 🔧 Background in **no-code development**, freelance design, and digital marketing
- 🤖 Currently exploring **autonomous agents**, wearable data integration, and computer vision
- 🎵 Hobbyist singer on the side
...
|--------------------------------------------------------|---------------------------------------------------|-----------------------------|
|[Lyra Estudos](https://lyraestudos.com.br)              |EdTech SaaS for vestibular prep with AI diagnostics|React · Supabase · TypeScript|
|[viniciusborelli.com.br](https://viniciusborelli.com.br)|Personal portfolio with animated hero              |HTML · CSS · Netlify         |
